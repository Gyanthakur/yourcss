          ...
          <div className="container mx-auto flex flex-col md:flex-row items-center px-6">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-lg md:text-xl">
                ...
                Our mission is to deliver innovative solutions tailored to your needs.
              </p>
            </div>
        ...
        <section className="py-12">
          <div className="container mx-auto px-6">
            ...
            <p className="text-lg text-center max-w-3xl mx-auto">
              At our company, we aim to revolutionize the way businesses interact with technology.
              Our goal is to provide solutions that empower your organization, streamline operations, and drive growth.
            </p>
          </div>
        </section>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-2/3 px-4">
          <p className="text-lg leading-8 text-justify">
            ...
            development, particularly in front-end technologies. I am currently
            pursuing a Bachelor of Technology (B.Tech) in Computer Science at
            Kamla Nehru Institute of Technology, Sultanpur, and will graduate in
            May 2025 with a CGPA of 8.75.
          </p>
          <p className="mt-4 text-lg leading-8 text-justify">
            Over the past few years, I have gained significant experience in web
            development, from building e-learning platforms to working on
          ...
          <p className="mt-4 text-lg leading-8 text-justify">
            I am always open to learning new technologies and exploring creative
            solutions to technical challenges. Feel free to explore my portfolio
        ...
        <section className="bg-blue-900 text-white py-12">
          <div className="container mx-auto text-center px-6">
            ...
            <p className="text-lg mb-8">
              We are always looking for talented individuals to join our team and help us create cutting-edge solutions.
            </p>
            <a
              href="/careers"
